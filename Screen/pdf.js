...
const pdf = (name, Address, Mobile_No, Quantity, Invoice, Product, Total,
    ReceivedBalance, PaymentType, RemainingBalance) => `
    <html>
      <head>
        <meta
          name="viewport"
      ...
      <body>
        ...
        >
          ...
          >
            ...
            <img
              style="height: 90px; width: 90px; margin-right: 15px"
            ...
            <table style="width: 100%; border-collapse: collapse">
              ...
              <tr style="background-color: rgba(246, 221, 178, 0.8)">
                ...
                <td style="text-align: center; height: 30px">
                  ${parseFloat(parseFloat(Total) / parseFloat(Quantity)
    ).toFixed(2)}
                </td>
